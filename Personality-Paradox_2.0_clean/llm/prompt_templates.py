...
分析："""
    ...
    def get_mbti_template(mbti_type: str) -> dict:
        ...
        # 讀取 MBTI 模板文件
        template_path = os.path.join(os.path.dirname(__file__), '..', 'data', 'mbti_templates.json')
    ...
    def get_zodiac_template(zodiac: str) -> dict:
        ...
        # 讀取星座模板文件
        template_path = os.path.join(os.path.dirname(__file__), '..', 'data', 'zodiac_templates.json')
    ...
    def get_dark_triad_template(scores: dict) -> str:
        ...
        # 讀取黑暗三角模板文件
        template_path = os.path.join(os.path.dirname(__file__), '..', 'data', 'dark_triad_templates.json')
...
這些特質反映了你在策略思維、自信心和情緒穩定性方面的傾向。請參考專業心理資源獲取更詳細的解讀。"""
    ...
    def get_bigfive_template(scores: dict) -> str:
        ...
        # 讀取 Big Five 模板文件
        template_path = os.path.join(os.path.dirname(__file__), '..', 'data', 'bigfive_templates.json')
